            ...
            <div className="flex flex-col min-h-screen">
                ...
                <div className="flex flex-col lg:flex-row gap-6 lg:gap-10 my-6 lg:my-10 mx-4 lg:ml-20 lg:mr-10">
                    ...
                    >
                        ...
                        <div className="absolute bottom-4 lg:bottom-15 left-1/2 -translate-x-1/2 w-[90%] lg:w-[800px] h-4 lg:h-6 bg-black/30 rounded-full blur-lg" />
                        {zoomed && (
                    ...
                    <div className="flex flex-col flex-1 mt-4 lg:mt-20">
                        ...
                        <div className="mt-4 lg:mt-2 gap-2 lg:mr-10 flex flex-wrap justify-center lg:justify-center items-center w-full">
