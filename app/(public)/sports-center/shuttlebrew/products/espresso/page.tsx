  ...
  return (
    <section className="w-full min-h-screen bg-[#f5f2ec] p-12">
      ...
      <nav className="flex items-center text-gray-600 text-sm mb-6">
        ...
        <span className="font-medium text-gray-900">Espresso</span>
      </nav>

      <h1 className="text-3xl font-bold mb-6">Espresso</h1>
      <p className="text-lg text-gray-700">
        Here you can display all the Espresso items, their images, descriptions, and prices.
      </p>
    </section>
  )
}
