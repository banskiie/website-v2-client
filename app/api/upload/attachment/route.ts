...
cloudinary.config({
  cloud_name: process.env.NEXT_PUBLIC_CLOUDINARY_UPLOAD_URL!,
  ...
  try {
    ...
    const uploadResult = await new Promise<any>((resolve, reject) => {
      const uploadStream = cloudinary.uploader.upload_stream(
        {
          folder: "attachments", // optional Cloudinary folder
          resource_type: "auto", // allows images, videos, docs
        },
        (error, result) => {
