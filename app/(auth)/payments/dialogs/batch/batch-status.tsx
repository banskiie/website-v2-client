...
const BATCH_CHANGE_USER_STATUS = gql`
  mutation BatchChangeUserStatus($input: BatchChangeUserStatusInput!) {
    batchChangeUserStatus(input: $input) {
      ok
      message
    }
  }
    ...
    <AlertDialog open={open} onOpenChange={setOpen}>
      <form>
        ...
        <AlertDialogContent onOpenAutoFocus={(e) => e.preventDefault()}>
          <AlertDialogHeader>
            <AlertDialogTitle>Batch Change User Status</AlertDialogTitle>
            <AlertDialogDescription>
              ...
              <span className="block text-xs">
                ...
                cannot change the status of your own user account.
              </span>
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
